...
router.patch("/jobs/:id/escrow", protect, authorize("Client"), transactionController.escrowPayment);
router.patch("/jobs/:id/release", protect, authorize("Client"), transactionController.releasePayment);
